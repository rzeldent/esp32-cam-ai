...
A Model Context Protocol (MCP) server implementation for ESP32-CAM that enables remote camera control, LED management, and system monitoring through standardized MCP tools offering AI capabilities.
